    ...
    <div className="border-[1px] border-slate-200 rounded-lg w-[200px] max-w-[30vw] flex-grow group flex flex-col">
      <div className="flex items-center overflow-hidden max-h-[200px]">
        <Image
          ...
          width={200}
          height={200}
          className="w-full group-hover:scale-[1.05] duration-500"
        ></Image>
      </div>
      <div className="bg-blue-500 rounded-br-lg rounded-bl-lg flex items-center justify-between gap-4 p-4 border-slate-400 border-t-[1px] flex-grow">
